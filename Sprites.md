...
The Sprite Tool has a drop-down menu option to help you optimize sprites. 

![image alt text](images/OptimizingSprites_image_0.png)

It attempts to remove duplicate and empty sprites from the `sprite.png`. You should make a copy of the sprite.png file before you attempt to optimize them because once you save the changes in the Sprite Tool, you won’t be able to undo the optimization.

![image alt text](images/OptimizingSprites_image_1.png)

Once the Sprite Tool optimizes your sprites, you’ll get a report on how much memory was saved and you can save your changes to update the `sprites.png` file. 

![image alt text](images/OptimizingSprites_image_2.png)